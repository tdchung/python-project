...
class MainFrame(wx.Frame):
    ...
    def main_panel_init(self):
        ...
        hbox_group_checkbox = wx.BoxSizer(wx.HORIZONTAL)

        self.box_listCheckbox = wx.StaticBox(self.panel, wx.ID_ANY, "GPS types")
        sb_sizer = wx.StaticBoxSizer(self.box_listCheckbox, wx.VERTICAL)
        grid_sizer = wx.GridSizer(1, 3, 3)
        self.check_box1 = wx.CheckBox(self.panel, id=wx.ID_ANY, label="Type 1")
        self.check_box2 = wx.CheckBox(self.panel, id=wx.ID_ANY, label="Type 2")
        self.check_box3 = wx.CheckBox(self.panel, id=wx.ID_ANY, label="Others")
        grid_sizer.Add(self.check_box1, 1, wx.LEFT, 0)
        grid_sizer.Add(self.check_box2, 1, wx.LEFT, 0)
        grid_sizer.Add(self.check_box3, 1, wx.LEFT, 0)
        sb_sizer.Add(grid_sizer, 1, wx.ALL|wx.LEFT, 10)

        hbox_buttons = wx.BoxSizer(wx.VERTICAL)
        self.show_com_ports = wx.Button(self.panel, label='Show Com ports', size=(150, 30))
        self.find_gps = wx.Button(self.panel, label='Find GPS', size=(150, 30))
        hbox_buttons.Add(self.show_com_ports, proportion=1, flag=wx.ALL | wx.EXPAND, border=2)
        hbox_buttons.Add(self.find_gps, proportion=1, flag=wx.ALL | wx.EXPAND, border=2)

        gs_checkbox = wx.GridSizer(1, 3, 0, 0)
        gs_checkbox.AddMany([(sb_sizer, 1, wx.ALIGN_BOTTOM| wx.EXPAND), (hbox_buttons, 1, wx.ALIGN_BOTTOM)])
        # gs_checkbox.AddGrowableCol(1, 1)
        hbox_group_checkbox.Add(gs_checkbox, proportion=1, flag=wx.ALL | wx.EXPAND, border=2)
