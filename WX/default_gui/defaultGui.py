            ...
            with open(result_file, "r") as f:
                for line in f:
                    ...
                    if match is not None:
                        ...
                        data_line = "%s\t%s\t%s\t%s" % \
                                    (match.group(1), match.group(2), match.group(3), result)
                        # else:
...
class MyExcelQC:
    ...
    def open_excel_file(self, file_path=myExcelFile):
        ...
        self.MyPrint.debug(" The total test case from xlsx file: " + str(numTests))
        testNameCol = self.excel_search_name(sheet, EXCEL_COLUMN_NAME_STR)
        testStatusCol = self.excel_search_name(sheet, EXCEL_COLUMN_TEST_STATUS_STR)
...
class MainFrame(wx.Frame):
    ...
    def main_panel_init(self):
        ...
        self.sText1 = wx.StaticText(self.panel, label='Lable 0', size=(100, 20))
        ...
        self.listSelect = ['PASSED', 'FAILED', 'NO RUN', 'N/A', 'BLOCKED', 'ALL']
        ...
        gs_comboBox.Add(self.cblistResult, 0, wx.LEFT | wx.RIGHT | wx.TOP |
                        wx.ALIGN_BOTTOM | wx.EXPAND)
        hbox_comboBox.Add(gs_comboBox, proportion=1, flag=wx.ALL | wx.EXPAND, border=2)
